...
- For this bot to work on linux, you will need to [update](https://cloudbytes.dev/snippets/upgrade-python-to-latest-version-on-ubuntu-linux) your python version from 3.8 to 3.10 or newer. Optionally, you can run this [bot in a docker environment](https://github.com/WebTheDev/TicketBot/tree/docker), which natively uses the latest version of python.

---
### Screenshots

<p align="center"><img src="https://tari.blue/assets/img/ticketbot-demo-1.gif" /></p><p align="center"><img src="https://tari.blue/assets/img/ticketbot-demo-2-1.gif" /></p>
